...
Detailed scan/database/AI architecture notes live in:
...
This is the recommended daily workflow. Open the QR code in Expo Go.

## Demo / seeded data mode

The app does not seed collection data by default anymore. To start with demo data, opt in explicitly in `.env.local`:
...
- router layout smoke coverage
- image persistence fallback behavior
