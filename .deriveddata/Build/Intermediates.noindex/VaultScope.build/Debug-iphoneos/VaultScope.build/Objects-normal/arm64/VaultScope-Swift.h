...
#ifndef VAULTSCOPE_SWIFT_H
#define VAULTSCOPE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VaultScope",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10VaultScope25AVFoundationCameraService")
@interface AVFoundationCameraService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVCapturePhotoOutput;
@class AVCapturePhoto;
@interface AVFoundationCameraService (SWIFT_EXTENSION(VaultScope)) <AVCapturePhotoCaptureDelegate>
...
@class NSCoder;
SWIFT_CLASS("_TtC10VaultScope20PreviewContainerView")
